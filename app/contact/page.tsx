...
export default function Contact() {
  ...
  const serviceData = [
    { number: '3,200+', label: '已服务客户', icon: '👥' },
    { number: '25+', label: '覆盖国家', icon: '🌎' },
    { number: '120+', label: '可提供学历院校', icon: '🎓' },
    { number: '98.7%', label: '客户满意率', icon: '⭐' },
    { number: '7~15天', label: '平均交付时效', icon: '⏰' }
  ];
  ...
  const advantages = [
    { title: '🔒 真实学历', value: '全程真实院校出具，支持认证查询' },
    { title: '🕐 快速出证', value: '最快5天，常规7~15天内完成' },
    { title: '📦 全套服务', value: '提供学历+成绩单+认证文件全流程' },
    { title: '🔍 多国认证', value: '支持海牙、WES、ECE、ICAS等国际认证' },
    { title: '👨‍💼 顾问1对1', value: '定制方案，快速匹配最合适的院校与流程' },
    { title: '📈 高满意度', value: '已服务3000+客户，满意度高达98.5%' }
  ];

  const faqs = [
    { question: '如何开始咨询？', answer: '直接点击WhatsApp按钮或拨打电话，我们的顾问会立即为您服务。' },
    { question: '咨询收费吗？', answer: '初次咨询完全免费，我们会根据您的需求提供详细的方案和报价。' },
    { question: '多久能收到回复？', answer: 'WhatsApp通常5分钟内回复，电话即时接听，邮件24小时内回复。' },
    { question: '信息会保密吗？', answer: '我们严格保护客户隐私，所有信息都会得到妥善保管和处理。' },
    { question: '认证材料是否真实？', answer: '所有认证材料均来自真实院校，支持官方验证，确保100%真实有效。' },
    { question: '支持哪些认证类型？', answer: '我们支持海牙认证、WES认证、ECE认证、ICAS认证、NACES认证等多种国际认证服务。' }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              <Link 
                href="https://wa.me/8612345678901?text=您好，我想咨询学历认证服务，希望了解适合我的学历方案"
                target="_blank" 
          ...
          <section className="py-16 px-6 bg-white">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">我们提供的学历及认证文件均来自真实可查院校，部分如下展示。</p>
              </div>
          ...
          <section className="py-16 px-6 bg-gray-50">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-4xl mx-auto leading-relaxed">我们的团队由认证顾问、档案审核师、国际认证专家组成，具备多年经验，服务遍及北美、东南亚、港澳等国家和地区，深谙各国认证体系，保障您快速、安全、高质量获取真实可查学历文件。</p>
              </div>
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 px-6 py-3 rounded-full text-sm font-medium">
                  <span>📌</span>我们承诺：每位顾问均通过严格认证培训，保障服务质量与信息保密。
                </div>
              </div>
            </div>
          </section>
                ...
                {faqs.map((faq, index) => (
                  <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    >
                      ...
                      <svg className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${expandedFAQ === index ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
